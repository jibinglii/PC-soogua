  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="goods-info">
        ...
        <div class="content">
          <el-form ref="form-info" :model="param" label-width="80px">
            <el-form-item label="交易主类">
              <el-col :span="12">
                <el-select v-model="param.type2" placeholder="请选择">
                  <el-option
            ...
            <el-form-item label="交易辅类">
              <el-col :span="12">
                <el-select v-model="param.game_id" placeholder="请选择" @change="loadServer">
                  <el-option
            ...
            <el-form-item label="商品属性">
              <el-col :span="12">
                <el-select v-model="param.server_id" placeholder="请选择商品属性" @Change="setServerName">
                  <el-option-group v-for="(group,index) in servers" :key="index" :label="index">
                    <el-option
        ...
        <div class="content">
          <el-form ref="form-info" :model="param" label-width="80px">
            ...
            <el-form-item label="发布数量">
              ...
              <el-col class="line" :span="1">件</el-col>
            </el-form-item>
          </el-form>
          <div class="info-tips">
      ...
      <div class="goods-desc">
        ...
        <div class="content">
          <el-form ref="form-desc" :model="param" label-width="80px">
              ...
              <el-col :span="15">
                ...
                >
                  ...
                  <div slot="file" slot-scope="{file}">
                    <img class="el-upload-list__item-thumbnail" :src="file.url" alt="nihao a ">
          ...
          <el-checkbox class="cehckbox" v-model="isagree" checked>
            我同意
      ...
      <div class="nextstep">
        <el-button @click.native.prevent="onNext" type="button" size="medium">提交审核</el-button>
      </div>
    </div>
    <v-footer/>
  </div>
