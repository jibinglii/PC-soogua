  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="goods-desc">
        ...
        <div class="content">
          <el-form ref="form-desc" :model="param" label-width="100px">
      ...
      <div class="nextstep">
        <el-button @click.native.prevent="next" type="button" size="medium">下一步</el-button>
      </div>
    </div>
    <v-footer/>
  </div>
    ...
    next() {
      if (!this.isagree) {
        ...
        if (!this.saving) {
          ...
          this.$http
            .post("api/v1/goods/update/" + this.goods.uuid, this.param)
            .then(res => {
              this.saving = false;
              loading.close();
              if (this.hasSpec) {
