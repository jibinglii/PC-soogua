      ...
      <v-content>
        ...
        <div slot="main">
          ...
          <div class="preview-bd">
            <div class="preview">
              <div class="one">
                ...
                <div class="right">
                  <el-button @click="withdraw" type="button" size="primary">申请提现</el-button>
                </div>
              </div>
              <div class="two">
                <div class="left">
          ...
          <div class="settlelist">
            <el-table :data="items" style="width: 100%; text-align:center;">
              <el-table-column align="center" prop="order_id" label="订单号"></el-table-column>
              <el-table-column align="center" prop="order.goods_title" label="商品名称"></el-table-column>
              ...
              <el-table-column
                ...
                prop="settle_amount"
                label="结算金额"
                :formatter="settleNumsFormat"
              ></el-table-column>
              <el-table-column align="center" prop="created_at" label="结算时间"></el-table-column>
            </el-table>
          </div>
          <pagination :total="total" :display="display" :current-page="page" @pagechange="getData"></pagination>
        </div>
      </v-content>
    </div>
    <v-footer/>
...
export default {
  ...
  methods: {
    totalNumsFormat(row, column) {
      return "￥" + row.order.total_amount;
    },
    settleNumsFormat(row, column) {
