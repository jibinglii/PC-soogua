<template>
  <div class="login_form">
    <div class="form_title">
      ...
      <img @click="changeForm(0)" src="~$assets/images/qr_icon.png">
    </div>
    <div class="form_body">
      <el-input
        class="phone"
      ...
      <el-row class="code" :gutter="10">
        <el-col :span="15">
          <el-input type="text" @keyup.enter="submit" v-model="param.code" placeholder="请输入验证码">
        ...
        <el-col :span="9">
          ...
          >{{ vCodeLabel }}</el-button>
        </el-col>
      </el-row>

      <el-button class="login-btn" @click="loginByCode">登录</el-button>
    </div>
    <hr>
