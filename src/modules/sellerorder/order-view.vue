            ...
            <div class="content">
              ...
              <div class="order-info">
                <div class="left">
                  ...
                  <div v-show="order.payment_time" class="order-time">
                    <span>付款时间</span>
                ...
                <div class="right">
                  <img :src="order_status[order.status].icon" alt>
                  <span>{{order_status[order.status].status_desc_1}}</span>
                </div>
              </div>
              <div v-if="order.status>1" class="subtitle">
                <span>发货信息</span>
              </div>
              <div v-if="order.status>1" class="order-info">
                <div class="left">
                  <div class="order-time">
                    <span>发货时间</span>
              ...
              <div v-if="order.status==1" class="nextstep">
                <el-button @click.native="shipping()" type="button" size="medium">确认发货</el-button>
              </div>
