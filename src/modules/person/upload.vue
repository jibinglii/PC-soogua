  ...
  <div class="upload">
    ...
    <div class="up-graphic">
      ...
      <input
        ...
        v-show="false"
      >
      <el-button @click="editIcon" type="primary">点击上传</el-button>
    </div>
    <i>示例：</i>
    <div class="eg-graphic">
      <img :src="content[prop].exampleImg">
      <el-button size="small" type="primary" @click="showDialog=true">查看详情要求</el-button>
    </div>
    <s class="desc_tip">{{content[prop].desc}}</s>
    <el-dialog :title="dialogContent[prop].title" :visible.sync="showDialog">
      <div class="dialog-img">
        <img :src="dialogContent[prop].img" alt>
      </div>
      <p class="desc">{{dialogContent[prop].desc}}</p>
    </el-dialog>
  </div>
</template>
    ...
    return {
      ...
      dialogContent: {
        zheng: {
          ...
          desc:
            "\n 1. 身份证上的信息不能被遮挡，且清晰可见\n 2. 照片请勿进行任何软件处理\n 3. 照片支持jpge/jpg/gif/bmp/png格式，最大不超过500KB"
        },
        fan: {
          title: "查看详情",
