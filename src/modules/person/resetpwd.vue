          ...
          <div class="setpwd">
            ...
            >
              <el-form-item prop="pass">
                <el-input type="password" v-model="pwd.pass" placeholder="请输入登录密码" auto-complete="off"></el-input>
              </el-form-item>
              <el-form-item prop="checkPass">
                <el-input type="password" v-model="pwd.checkPass" placeholder="请确认登录密码" auto-complete="off"></el-input>
              </el-form-item>
              <el-form-item>
