        ...
        <div slot="main">
          <div class="user-center">
            ...
            <div class="info">
              <div class="left">
                <div class="base">
                  <img v-if="currentUser.avatar!=''" class="icon" :src="currentUser.avatar" alt>
                  <img v-else class="icon" src="~$assets/images/gerentouxiang.png" alt>
                  <span>上午好！{{currentUser.nickname}}</span>

                  <router-link tag="a" :to="{name:'person.profile'}">
                    <img class="edit" src="~$assets/images/bianji.png" alt>
                  </router-link>
                </div>
                <ul>
              ...
              <div class="right">
                <p>快捷入口</p>
                <div class="group">
                  <a tag="a" @click="toMyStore" class="graphic m-right">
          ...
          <div class="safe-center">
            ...
            <div class="safe-list">
              <div class="safe-item">
                <div class="left">
                  <img v-if="pwdImg" src="~$assets/images/true.png" alt>
                  <img v-else src="~$assets/images/false.png" alt>
                  <i>登录密码</i>
                  <span>英文加数字或者富豪的组合密码，安全性更高，建议您定期更换密码。</span>
                </div>
                <router-link tag="a" :to="{name:'person.resetpwd'}">修改</router-link>
              </div>
              <div class="safe-item">
                <div class="left">
                  <img v-if="payImg" src="~$assets/images/true.png" alt>
                  <img v-else src="~$assets/images/false.png" alt>
                  <i>支付密码</i>
                  <span>在您支付时，输入正确的支付密码，保障您的资金和账户更安全。</span>
                </div>
                <router-link tag="a" :to="{name:'person.resetpaypwd'}">{{payImg?"修改":"设置"}}</router-link>
              </div>
              <div class="safe-item">
                <div class="left">
                  <img v-if="authImg" src="~$assets/images/true.png" alt>
                  <img v-else src="~$assets/images/false.png" alt>
                  <i>实名认证</i>
                  <span>发布商品时需完成实名认证，使您的交易更安全。</span>
                </div>
                <router-link tag="a" :to="{name:'person.approve'}">{{authImg?"通过":"认证"}}</router-link>
              </div>
            </div>
          </div>
