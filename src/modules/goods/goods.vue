		...
		<div class="container">
			...
			<el-container>
				<el-main>
					<h3>商品介绍</h3>
					<ul>
						<li v-for="(item, index) in goods.specs"
								:key="index"
								class="item">
					...
					<div class="main-img">
						<el-carousel indicator-position="outside"
												 :autoplay="true">
							<el-carousel-item v-for="(item,index) in goods.images"
																:key="index">
								<img :src="item"
										 alt>
							</el-carousel-item>
...
<script>
	...
	export default {
		...
		methods: {
			...
			createdQrcode () {
				let url = process.env.VUE_APP_H5_URL + "/" + window.STORE_ID + "/confirm/" + this.goodsId + ".html";
				if (this.$route.query["spread_id"] != undefined) {
					url += "?spread_id=" + this.$route.query["spread_id"]
				}
